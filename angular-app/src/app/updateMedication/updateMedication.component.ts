...
export class updateMedicationComponent implements OnInit {
  ...
  updateMedication = new FormControl('', Validators.required);
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      ...
      'updateMedication': this.updateMedication.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.updateMedication) {
        formObject.updateMedication = result.updateMedication;
      } else {
        formObject.updateMedication = null;
      }
